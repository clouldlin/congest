...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/map/map.event.js"></script>
...
<div id="map_container" class="congest_map">
	<div class="map_bar">	
		<button type="button" style="height: 69px;"><img src="${pageContext.request.contextPath}/images/map/btn/map_bar_btn01.gif" alt="지도 확장하기"></button>
	</div>
