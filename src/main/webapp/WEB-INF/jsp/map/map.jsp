...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/${script}"></script>
</head>
<body class="jui">
	<!-- wrap start -->
	<div id="wrap_map">
		...
		<c:import url="/WEB-INF/jsp/map/leftmenu.jsp" />
			...
			<div id="map_container" class="congest_map">
				<div class="map_bar">
					<button type="button">
						<img
							src="${pageContext.request.contextPath}/images/map/btn/map_bar_btn01.gif"
							alt="지도 확장하기">
					</button>
				</div>
				<div class="control_bar">
					<div class="area01">
						<span class="btn-group" id="base_map_select"> <a
							class="btn btn-mini btn-gray-black active" id="vworld_base_map">브이월드</a>
							<!-- <a class="btn btn-mini btn-gray-black" id="vworld_gray_map">흑백 (브이월드)</a> -->
							<a class="btn btn-mini btn-gray-black" id="vworld_satellite_map">브이월드
								- 위성</a> <a class="btn btn-mini btn-gray-black" id="google_base_map">구글</a>
							<a class="btn btn-mini btn-gray-black" id="google_satellite_map">구글
								- 위성</a> <a class="btn btn-mini btn-gray-black"
							id="openstreet_base_map">오픈스트리트맵</a> <!--  <a class="btn btn-mini btn-gray-black" id="openstreet_gray_map">흑백 (오픈스트리트맵)</a> -->
						</span> <span style="vertical-align: sub;">&nbsp;|&nbsp;</span> <span
							class="btn-group" id="map_additional_info"
							style="vertical-align: middle;"> <input type="checkbox"
							id="vworld_hybrid_map" name="vworld_hybrid_map"> <label
							for="vworld_hybrid_map" class="normal padright10"
							style="vertical-align: middle;">하이브리드</label> <input
							type="checkbox" id="real_traffic_info" name="road_level">
							<label for="real_traffic_info" class="normal"
							style="vertical-align: middle;">실시간 소통 정보</label> <!--
			...
			-->
					...
					<div class="area02">
						<fieldset>
							<select id="sido_cd" name="sido_cd" class="selbox"
								style="width: 120px" onchange="javascript:searchSggList()">
								<option value="">광역시/도</option>
								<c:forEach var="sidoCodeList" items="${sidoCodeList}"
									varStatus="status">
									<option value="${sidoCodeList.sidoCode}">${sidoCodeList.sidoNm}</option>
								</c:forEach>
							</select> <select id="sgg_cd" name="sgg_cd" class="selbox"
								style="width: 120px" onchange="javascript:searchEmdList()">
								<option value="">시/군/구</option>
							</select> <select id="umd_cd" name="umd_cd" class="selbox"
								style="width: 120px">
								<option value="">읍/면/동</option>
							</select>
							<!-- <a class="btn btn-mini btn-gray">이동</a> -->
							<input type="image"
								src="${pageContext.request.contextPath}/images/map/btn/map_address_move.gif"
								onclick="javascript:moveMapToLandCode()" alt="이동">
						</fieldset>
					</div>
				</div>
				<div id="map">
